...
pnpm typecheck && pnpm turbo run test && pnpm check:tenant   # typecheck (6 paquetes) · tests (api 130 + web 139 = 269) · guardrail
```
...
8. **Calidad** — 269 tests (130 API + 139 web), el set de verificación, las suites de integración clave.
