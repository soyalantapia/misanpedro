    ...
    <div className="animate-fade-up mx-auto flex w-full max-w-3xl flex-col gap-6 px-4 py-6 sm:px-6 sm:py-10">
      <div className="flex flex-col gap-1.5">
        ...
        <p className="text-base text-neutral-500">
          Cupones que activaste pero todavía no canjeaste. Tenés 30 minutos desde la activación.
        </p>
      </div>
      ...
      <div className="animate-fade-in mx-auto flex max-w-md flex-col items-center gap-3 rounded-3xl bg-white px-6 py-12 text-center shadow-card">
        ...
        <div>
          <h3 className="text-base font-bold text-neutral-900">Sin cupones activos</h3>
          <p className="mt-1 text-sm text-neutral-500">
            Cuando actives un descuento desde Descuentos, vas a verlo acá con su código QR y código
            numérico de respaldo.
          </p>
        </div>
      </div>
    </div>
