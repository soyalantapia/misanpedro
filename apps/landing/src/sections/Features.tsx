...
export function Features() {
  return (
    <section id="funciones" className="scroll-mt-20 px-6 py-24 sm:py-32">
      ...
      <div className="mx-auto mt-16 grid max-w-6xl gap-5 sm:grid-cols-2 lg:grid-cols-3">
        {FEATURES.map((f) => (
          ...
          >
            <span className="inline-grid h-11 w-11 place-items-center rounded-xl bg-accent-50 text-accent-700 transition-all group-hover:bg-accent-100">
              <f.icon size={18} />
            </span>
