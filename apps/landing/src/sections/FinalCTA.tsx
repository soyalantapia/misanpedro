...
export function FinalCTA() {
  ...
  return (
    <section className="px-6 pb-20 pt-12 sm:pb-28">
      <AnimatedSection className="relative mx-auto max-w-5xl overflow-hidden rounded-[2rem] bg-gradient-to-br from-accent-600 via-accent-700 to-accent-800 p-10 text-center text-on-brand shadow-2xl shadow-accent-500/20 sm:p-16">
        {/* Decorative orbs */}
