    ...
    <div className="animate-fade-up mx-auto flex w-full max-w-3xl flex-col gap-5 px-4 pt-6 pb-8 sm:px-6 sm:pt-10">
      <header className="flex flex-col gap-1.5">
        ...
        <p className="text-sm text-neutral-500">
          ...
          <strong className="text-neutral-700">1 semana gratis</strong> (hasta {data?.cap ?? 8}). Y
          tu colega arranca con <strong className="text-neutral-700">15 días extra</strong>.
        </p>
      </header>
      ...
      {!loading && error && (
        <div className="flex flex-col items-start gap-3 rounded-3xl bg-white p-5 shadow-card ring-1 ring-neutral-100">
          ...
          <button
            type="button"
            onClick={refetch}
            className="rounded-2xl bg-accent-500 px-4 py-2 text-sm font-bold text-white shadow-cta hover:-translate-y-0.5"
          >
            Reintentar
          </button>
        </div>
      ...
      {!loading && data && (
        <>
          ...
          <div className="overflow-hidden rounded-3xl bg-white shadow-floating ring-1 ring-neutral-100">
            <div className="bg-gradient-to-br from-accent-400 to-accent-600 px-5 py-5 text-white">
              <p className="text-[11px] font-bold uppercase tracking-widest text-accent-50">
            ...
            <div className="flex flex-col gap-3 p-5">
              <div className="flex items-stretch gap-2">
                <input
                  ...
                  className="min-w-0 flex-1 rounded-2xl bg-primary-50 px-4 py-3 text-sm text-neutral-700 ring-1 ring-neutral-200 focus:outline-none focus:ring-2 focus:ring-accent-400"
                />
                <button
                  type="button"
                  onClick={copyLink}
                  ...
                  className={cn(
                    ...
                    copied
                      ...
                      : 'bg-primary-100 text-neutral-600 ring-neutral-200 hover:bg-primary-200',
                  )}
                >
              ...
              <a
                ...
                className="flex items-center justify-center gap-2 rounded-2xl bg-gradient-to-br from-accent-400 to-accent-600 px-6 py-3.5 text-base font-bold text-white shadow-cta transition-all hover:-translate-y-0.5"
              >
          ...
          <div className="grid grid-cols-2 gap-2.5">
            <div className="flex flex-col gap-1 rounded-2xl bg-white p-4 shadow-card ring-1 ring-neutral-100">
              <span className="inline-flex w-fit items-center gap-1 rounded-full bg-accent-50 px-2 py-0.5 text-[10px] font-bold uppercase tracking-widest text-accent-700">
                <Gift size={10} /> Vos ganás
              </span>
              <p className="text-xl font-bold leading-tight text-neutral-900">1 semana gratis</p>
              <p className="text-[11px] leading-snug text-neutral-500">por cada comercio (hasta 8 = 2 meses)</p>
            </div>
            <div className="flex flex-col gap-1 rounded-2xl bg-white p-4 shadow-card ring-1 ring-neutral-100">
              ...
              <p className="text-xl font-bold leading-tight text-neutral-900">15 días extra</p>
              <p className="text-[11px] leading-snug text-neutral-500">al publicar su primer descuento</p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-3 rounded-2xl bg-status-success-bg/60 p-4 ring-1 ring-status-success/20">
            <span className="grid h-9 w-9 shrink-0 place-items-center rounded-xl bg-white text-status-success-fg ring-1 ring-status-success/20">
              <ShieldCheck size={18} />
            </span>
          ...
          <section className="flex flex-col gap-2.5">
            ...
            <div className="flex flex-col gap-2 rounded-2xl bg-gradient-to-br from-accent-400 to-accent-600 p-4 text-white shadow-cta">
              <div className="flex items-center justify-between">
                <span className="inline-flex items-center gap-1.5 text-[11px] font-bold uppercase tracking-widest text-accent-50">
              ...
              <p className="text-[11px] text-accent-50/90">
                {data.weeksEarned >= data.cap
                  ? '¡Llegaste al tope! Gracias por sumar comercios.'
                  : `Te quedan ${data.cap - data.weeksEarned} semanas por ganar.`}
              </p>
            </div>
            <div className="flex items-center gap-3 rounded-2xl bg-white p-4 shadow-card ring-1 ring-neutral-100">
              ...
              <div className="min-w-0">
                ...
                <p className="text-base font-bold text-neutral-900">{formatDate(data.freeTrialUntil)}</p>
              </div>
            </div>
          </section>
          ...
          {referidos.data && (
            <section className="flex flex-col gap-2.5">
              ...
              {referidos.data.length === 0 ? (
                <div className="flex items-center gap-3 rounded-2xl border border-dashed border-neutral-200 bg-white/60 p-4">
                  ...
                  <p className="text-xs leading-snug text-neutral-500">
                    ...
                    <strong className="text-neutral-700">Compartí tu link</strong> y acá vas a ver a
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <div
                    key={r.id}
                    className="flex items-center gap-3 rounded-2xl bg-white p-3.5 shadow-card ring-1 ring-neutral-100"
                  >
                    <span className="grid h-9 w-9 shrink-0 place-items-center rounded-xl bg-accent-50 text-accent-700">
                      <Store size={16} />
                    </span>
          ...
          {/* Cómo funciona */}
          <section className="flex flex-col gap-3 rounded-3xl bg-white p-5 shadow-card ring-1 ring-neutral-100">
            <p className="inline-flex items-center gap-1.5 text-[11px] font-bold uppercase tracking-widest text-neutral-500">
              <Sparkles size={12} className="text-accent-500" /> Cómo funciona
            </p>
...
function Stat({
  ...
  return (
    <div
      className={cn(
        'flex flex-col gap-1.5 rounded-2xl px-3 py-3.5 text-center shadow-card ring-1 ring-neutral-100',
        accent ? 'bg-gradient-to-br from-accent-400 to-accent-600 text-white' : 'bg-white',
      )}
    >
      <Icon size={16} className={cn('mx-auto', accent ? 'text-accent-50' : 'text-accent-500')} />
      <p
        className={cn(
  ...
  return (
    <div className="flex items-start gap-3">
      ...
      <div className="flex-1">
        ...
        <p className="text-xs leading-snug text-neutral-500">{children}</p>
      </div>
    </div>
  )
}
...
function ReferidosSkeleton() {
  return (
    <div className="flex flex-col gap-5">
      <div className="h-44 w-full animate-pulse rounded-3xl bg-white shadow-card" />
