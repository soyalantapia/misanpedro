          ...
          <div className="rounded-3xl bg-surface p-6 text-ink shadow-[0_30px_80px_-20px_rgba(0,0,0,0.5)] ring-1 ring-on-brand/10 sm:p-7">
            ...
            <form onSubmit={handleSubmit} className="mt-5 flex flex-col gap-4">
                ...
                input={
                  <div className="relative">
                    ...
                    <button
                      ...
                      className="absolute right-3 top-1/2 grid h-7 w-7 -translate-y-1/2 place-items-center rounded-full text-ink-faint hover:bg-surface-2 hover:text-ink"
              ...
              <button
                type="submit"
                disabled={submitting}
                className="mt-1 flex items-center justify-center gap-2 rounded-2xl bg-gradient-to-br from-brand to-brand-strong px-6 py-3.5 text-base font-bold text-on-brand shadow-cta transition-all duration-200 hover:-translate-y-0.5 hover:from-brand-strong hover:to-brand-strong hover:shadow-floating active:translate-y-0 active:scale-[0.98] disabled:opacity-60"
              >
              ...
              <Link
                ...
                className="text-center text-xs font-semibold text-ink-soft hover:text-brand-strong"
              >
