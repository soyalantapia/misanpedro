...
export function CuponDetailPage() {
  ...
  const coupon: Coupon | undefined = apiCoupon
    ? {
        ...
        precioReferencia: apiCoupon.precioReferencia,
        precioFijo: apiCoupon.precioFijo,
        ...
        tipoOferta: apiCoupon.tipoOferta,
        franjaDesde: apiCoupon.franjaDesde,
        franjaHasta: apiCoupon.franjaHasta,
